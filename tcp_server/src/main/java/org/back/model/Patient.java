...
public class Patient {
    ...
    public Patient(String patient_id, String full_name, String document_id, int age, char sex, String contact_email, String registration_date, String clinical_notes, String checksum_fasta, int file_size_bytes,  String status) {
